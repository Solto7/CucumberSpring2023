...
public class Helper {
    ...
    public static void chooseDate(String date, WebElement calendarValue,
        ...
        monthKeeper.put("January", "01");
        monthKeeper.put("February", "02");
        monthKeeper.put("March", "03");
        monthKeeper.put("April", "04");
        monthKeeper.put("May", "05");
        monthKeeper.put("June", "06");
        monthKeeper.put("July", "07");
        monthKeeper.put("August", "08");
        monthKeeper.put("September", "09");
        monthKeeper.put("October", "10");
        monthKeeper.put("November", "11");
        monthKeeper.put("December", "12");
        ...
        while (true) {
            ...
            if (forward) {
                Helper.click(forwardButton);
            } else {
                Helper.click(backwardButton);
            }
